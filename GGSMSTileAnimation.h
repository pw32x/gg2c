...
private:
	...
	void WriteHeaderFile(const std::string& outputFolder, const std::string& outputName);
	void WriteSourceFile(const std::string& outputFolder, const std::string& outputName);
